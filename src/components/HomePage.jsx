  ...
  return (
    <div className="linkagotchi-homepage nes-container">
      <header className="homepage-header">
        <h1 className="nes-text is-primary">Rootagotchi</h1>
        {!isConnected && (
      ...
      <main className="homepage-main">
        ...
        <section className="hero-section nes-container with-title">
          <h2 className="title">Welcome to Rootagotchi!</h2>
          <p>Blockagotchis meet Bitcoin. Collect, raise, and battle with your own blockchain pets!</p>
        ...
        <section className="features-section">
          ...
          <ul className="nes-list is-circle">
            <li>Collect unique Blockagotchi pets</li>
            <li>Train and evolve your Blockagotchi</li>
        ...
        <section className="how-to-play nes-container with-title">
          ...
          <ol className="nes-list is-numbered">
            ...
            <li>Get your first Blockagotchi</li>
            <li>Feed and train your pet</li>
            <li>Trade and collect rare Blockagotchis</li>
          </ol>
        </section>
      </main>

      <footer className="homepage-footer nes-container">
        <p>&copy; 2024 Rootagotchi. All rights reserved.</p>
